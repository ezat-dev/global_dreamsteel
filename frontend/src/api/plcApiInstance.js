...
/* ===========================================================================
   C#(PlcApiServer) 직통 인스턴스 — 값 읽기 전용이다.

   쓰기는 자바(8081)를 거친다. C#은 로그인한 사용자를 모르는데(세션은 자바에 있다)
   scada_log에 "누가 무엇을 바꿨나"를 남겨야 하기 때문이다. 읽기만 직통으로 두는 이유는
   1초마다 도는 경로에서 홉을 하나 줄이려는 것이고, 읽기는 기록할 것이 없다.
